  ...
  return (
    <footer className="bg-black text-gray-300 py-12 border-t border-yellow-500/20">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        >
          <h3 className="text-xl font-semibold text-yellow-400 mb-4">Kontak Kami</h3>
        ...
        >
          <h3 className="text-xl font-semibold text-yellow-400 mb-4">Ikuti Kami</h3>
      ...
      {/* Garis Bawah */}
      <div className="border-t border-yellow-500/10 mt-10 pt-6 text-center text-sm text-gray-500">
