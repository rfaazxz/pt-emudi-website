      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {images.map((src, index) => (
            <motion.div
              key={index}
              className="overflow-hidden rounded-2xl shadow-lg cursor-pointer hover:shadow-yellow-400/30"
            ...
            >
              <motion.img
                src={src}
                alt={`Galeri ${index + 1}`}
                className="object-cover w-full h-64 hover:opacity-80 transition duration-300"
